...
class Application:
    def __init__(self):
        ...
        self.panel.place(x = 460, y = 95, width = 640, height = 250)
        self.panel2 = tk.Label(self.root) # initialize image panel
        self.panel2.place(x = 135, y = 95, width = 310, height = 250)
        
        self.T = tk.Label(self.root)
        self.T.place(x=31,y = 17)
        self.T.config(text = "Sign Language to Text",font=("courier",30,"bold"))
        self.panel3 = tk.Label(self.root) # Current SYmbol
        self.panel3.place(x = 500,y=350)
        self.T1 = tk.Label(self.root)
        self.T1.place(x = 10,y = 350)
        self.T1.config(text="Character :",font=("Courier",30,"bold"))
        self.panel4 = tk.Label(self.root) # Word
        self.panel4.place(x = 220,y=400)
        self.T2 = tk.Label(self.root)
        self.T2.place(x = 10,y = 400)
        self.T2.config(text ="Word :",font=("Courier",30,"bold"))
        self.panel5 = tk.Label(self.root) # Sentence
        self.panel5.place(x = 350,y=450)
        self.T3 = tk.Label(self.root)
        self.T3.place(x = 10,y = 450)
        self.T3.config(text ="Sentence :",font=("Courier",30,"bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x = 250,y = 500)
